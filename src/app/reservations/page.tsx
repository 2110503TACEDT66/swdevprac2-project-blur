...
export default function Reservations (){
  ...
  const [pickupDate, setPicupDate] = useState<Dayjs|null>(null)
  const [pickupLocation, setPicupLocation] = useState<string>('BKK')
    ...
    <main className="w-[100%] flex flex-col items-center space-y-4">
      ...
      <div className="w-fit space-y-2">
         <div className="text-md text-left text-gray-600">Pick-Up Date and Location</div>
          <LocationDateReserve onDateChange={(value:Dayjs)=>{setPicupDate(value)}}
          onLocationChange={(value:string)=>setPicupLocation(value)}/>
