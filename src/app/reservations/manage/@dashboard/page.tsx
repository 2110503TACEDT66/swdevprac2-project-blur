...
import Car from "@/db/models/Dentists";
...

      {
        ...
        <form action={addCar}>
          ...
          <div className="flex items-center w-1/2 my-2">
              ...
              <input type="text" required id="picture" name="picture" placeholder="URL Picture"
              className="bg-white border-2 border-gray-200 rounded w-full p-2 text-gray-700 focus:outline-none focus:border-blue-400"/>
          </div>
          <div className="flex items-center w-1/2 my-2">
              ...
              <label className="w-auto block text-gray-700 pr-4 ml-5
              " htmlFor="doors">Doors</label>
          ...
          <div className="flex items-center w-1/2 my-2">
              ...
              <label className="w-auto block text-gray-700 pr-4 ml-5" htmlFor="smallbags">Small Bage</label>
          ...
          <div className="flex items-center w-1/2 my-2">
              ...
              <input type="text" required id="dayRate" name="dayRate" placeholder="Daily Rate (including inisurance)"
              className="bg-white border-2 border-gray-200 rounded w-full p-2 text-gray-700 focus:outline-none focus:border-blue-400"/>
          </div>
          <button type="submit" className="bg-blue-500 rounded hover:bg-blue-700 text-white p-2">Add New Car</button>
        </form>
        : null
      }
          </main>
